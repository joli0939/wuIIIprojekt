...
class Login {
    ...
    public function createUser($username, $password, $firstName, $lastName) {
        ...
        $sql = "INSERT INTO book_users (username, password, firstname, lastname) VALUES ('" . $this->username . "', '" . $this->password . "', '" . $this->firstName . "', '" . $this->lastName . "');";
    ...
    public function checkIfUserExists($username) {
        ...
        $sql = "SELECT * FROM book_users WHERE username='$username';";
    ...
    public function checkLogin($username, $password) {
        ...
        $sql = "SELECT id FROM book_users WHERE username='$username' and password = BINARY '$password'";
        $result = $this->db->query($sql);
